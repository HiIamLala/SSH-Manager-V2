    ...
    try{
        ...
        io.on('connection', function (client) {
            ...
            client.on('setup_new_connection', function (data) {
                ...
                console.log(session_prop.token[0]);
                query.ssh(session_prop.token[0], (err, result) => {
                    ...
                    if(err){
                        ...
                        var result_log_stream = require('fs').createWriteStream("./log/" + project_id + "/" + instance_id + "/" + username + "/" + dateTime + "-result.rec", { flags: 'a' });
                        ...
                        conn.on('ready', function () {
                            ...
                            port: 22,
                            username:  result.InstanceProps.SSHUsername,
